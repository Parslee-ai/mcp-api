...
- **Project Renamed** - AnyAPI renamed to MCP-API
  - Repository: `Parslee-ai/anyapi` → `Parslee-ai/mcp-api`
  - Namespaces: `AnyAPI.*` → `McpApi.*`
  - Database: `anyapi` → `mcpapi`
  - User-Agent: `AnyAPI/1.0` → `McpApi/1.0`
...
[Unreleased]: https://github.com/Parslee-ai/mcp-api/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/Parslee-ai/mcp-api/releases/tag/v1.0.0
